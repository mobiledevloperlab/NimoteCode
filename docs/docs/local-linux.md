---
title: Android Local Linux | NimoteCode
description: Install and use NimoteCode's bundled Ubuntu development environment on supported Android devices, without root access.
---
...
Next: [Local and Remote SSH Workspaces](/docs/ssh) · [Terminal](/docs/terminal) · [AI Chat and Agent](/docs/ai)
